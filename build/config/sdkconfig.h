...
#define CONFIG_BT_NIMBLE_MAX_EXT_ADV_INSTANCES 3
#define CONFIG_BT_NIMBLE_EXT_ADV_MAX_SIZE 1650
#define CONFIG_BT_NIMBLE_ENABLE_PERIODIC_ADV 1
#define CONFIG_BT_NIMBLE_PERIODIC_ADV_SYNC_TRANSFER 1
...
#define CONFIG_BT_CTRL_SCAN_BACKOFF_UPPERLIMITMAX 32
#define CONFIG_BT_LE_CTRL_ADV_DATA_LENGTH_ZERO_AUX 1
#define CONFIG_BT_LE_RXBUF_OPT_ENABLED 1
#define CONFIG_BT_LE_CTRL_FAST_CONN_DATA_TX_EN 1
#define CONFIG_BT_LE_EXT_ADV_RESERVED_MEMORY_COUNT 2
#define CONFIG_BT_LE_CONN_RESERVED_MEMORY_COUNT 2
#define CONFIG_BT_LE_ADV_SCHED_PRIO_LOW_LEVEL 1
#define CONFIG_BT_LE_DFT_ADV_SCHED_PRIO_LEVEL 0
#define CONFIG_BT_LE_PERIODIC_ADV_SCHED_PRIO_MID_LEVEL 1
#define CONFIG_BT_LE_DFT_PERIODIC_ADV_SCHED_PRIO_LEVEL 1
#define CONFIG_BT_LE_SYNC_SCHED_PRIO_MID_LEVEL 1
#define CONFIG_BT_LE_DFT_SYNC_SCHED_PRIO_LEVEL 1
...
#define CONFIG_ESP_WIFI_STATIC_RX_BUFFER_NUM 4
#define CONFIG_ESP_WIFI_DYNAMIC_RX_BUFFER_NUM 8
